...
import { Building2, Home, Shield, Star, Users, MapPin, ArrowLeft } from "lucide-react"

export default function IECHomePage() {
  return (
      ...
      <header className="bg-blue-600 text-white py-6">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="inline-flex items-center text-blue-100 hover:text-white">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Blazing Team
            </Link>
            <h1 className="text-3xl font-bold text-center flex-1">iEC Estate & Accommodations</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
              <Link href="/iec/search?type=apartment">
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
              <Link href="/iec/search?type=lodge">
                <CardHeader className="text-center pb-4">
